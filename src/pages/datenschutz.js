...
const Datenschutz = () => (
    <Layout style={{
        ...
        <p>
            ...
            <br/> E-Mail: hallo@paulborm.de
        </p>
        <h2 id="sicherheit-und-schutz-ihrer-personenbezogenen-daten">Sicherheit und Schutz Ihrer personenbezogenen Daten</h2>
        ...
        <p>5. <strong>Pseudonymisierung</strong></p>
        ...
        <p>6. <strong>Dateisystem</strong></p>
        ...
        <p>7. <strong>Verantwortlicher</strong></p>
        ...
        <p>8. <strong>Auftragsverarbeiter</strong></p>
        <p>„Auftragsverarbeiter“ ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die personenbezogene Daten im Auftrag des Verantwortlichen verarbeitet.  </p>
        <p>9. <strong>Empfänger</strong></p>
        ...
        <h2 id="information-ber-die-erhebung-personenbezogener-daten">Information über die Erhebung personenbezogener Daten</h2>
        ...
        <h3 id="erhebung-personenbezogener-daten-bei-besuch-unserer-website">Erhebung personenbezogener Daten bei Besuch unserer Website</h3>
        ...
        <ul>
            ...
            <li><p>Persistente Cookies (dazu 2.).</p>
            </li>
            <li><p>Transiente Cookies werden automatisiert gelöscht, wenn Sie den Browser schließen. Dazu zählen insbesondere die Session-Cookies. Diese speichern eine sogenannte Session-ID, mit welcher sich verschiedene Anfragen Ihres Browsers der gemeinsamen Sitzung zuordnen lassen. Dadurch kann Ihr Rechner wiedererkannt werden, wenn Sie auf unsere Website zurückkehren. Die Session-Cookies werden gelöscht, wenn Sie sich ausloggen oder den Browser schließen.</p>
            </li>
        ...
        <h3 id="-5-recht-auf-l-schung-recht-auf-vergessen-werden-">(5) Recht auf Löschung („Recht auf vergessen werden“)</h3>
        ...
        <h3 id="-6-recht-auf-einschr-nkung-der-verarbeitung">(6) Recht auf Einschränkung der Verarbeitung</h3>
        ...
        <h3 id="-7-recht-auf-daten-bertragbarkeit">(7) Recht auf Datenübertragbarkeit</h3>
        ...
        <h3 id="-9-automatisierte-entscheidungen-im-einzelfall-einschlie-lich-profiling">(9) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</h3>
        ...
        <h3 id="-10-recht-auf-beschwerde-bei-einer-aufsichtsbeh-rde">(10) Recht auf Beschwerde bei einer Aufsichtsbehörde</h3>
        ...
        <h3 id="-11-recht-auf-wirksamen-gerichtlichen-rechtsbehelf">(11) Recht auf wirksamen gerichtlichen Rechtsbehelf</h3>
